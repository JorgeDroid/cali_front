...
import { ClientRegistrationModal } from './brands-tables/new-client-modal';
import { Brand } from './brands-tables/components_brand-list';
import BrandsList from './brands-tables/components_brand-list';
